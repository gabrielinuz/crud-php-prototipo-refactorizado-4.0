...
CREATE DATABASE IF NOT EXISTS students_db_4
CHARACTER SET utf8 
COLLATE utf8_unicode_ci;

/*Crear usuario de la base de datos*/
CREATE USER 'students_user_4'@'localhost' IDENTIFIED BY '12345';

/*Otorgar todos los permisos sobre la base de datos*/
GRANT ALL PRIVILEGES ON students_db_4.* TO 'students_user_4'@'localhost';
...
O PARA MAYOR SEGURIDAD CON EL USUARIO students_user_4****************************/
...
CREATE TABLE subjects (
    ...
    syllabus_path VARCHAR(255) NOT NULL
) ENGINE=INNODB;

/*Insertar materias de prueba*/
INSERT INTO subjects (name, syllabus_path) VALUES 
('Fundamentos de la Programación', './uploads/682fa2d9974e3_FUNDAMENTOS_DE_LA_PROGRAMACION.pdf'), 
('Informática Básica', './uploads/682fa34a01c26_INFORMATICA_BASICA.pdf');
...
/*REVOKE ALL PRIVILEGES, GRANT OPTION FROM 'students_user_4'@'localhost';
DROP USER 'students_user_4'@'localhost';
DROP DATABASE students_db_4;*/